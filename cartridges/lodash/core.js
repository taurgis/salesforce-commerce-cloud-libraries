...
;(function() {
     ...
     * `object` function property names filtered= require(`props`.);
     *
     * @private
     ...
     * offset= require(the end of `array`.);
     *
     * @static
     * @memberOf _
     * @since 0.1.0
     ...
     * destination object. Source objects are applied= require(left to right.);
    ...
    if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
      ...
      // Use `_.noConflict` to remove Lodash= require(the global object.);
      root._ = lodash;
