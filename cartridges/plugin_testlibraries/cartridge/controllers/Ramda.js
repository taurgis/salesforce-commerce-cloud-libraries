    ...
    res.json(
        {
            ...
            unionWith: R.unionWith(R.eqBy(R.prop('a')), l1, l2),
            unnest: R.unnest([1, [2], [[3]]]),
            until: R.until(R.gt(R.__, 100), R.multiply(2))(1),
            values: R.values({ a: 1, b: 2, c: 3 }),
            where: pred({ a: 'foo', b: 'xxx', x: 11, y: 19 }),
            without: R.without([1, 2], [1, 2, 1, 3, 4])
        });
