...
module.exports = {
    isProtectedDayOfYearToken: function isProtectedDayOfYearToken(token) {
        return protectedDayOfYearTokens.indexOf(token) !== -1;
    },
    isProtectedWeekYearToken: function isProtectedWeekYearToken(token) {
        return protectedWeekYearTokens.indexOf(token) !== -1;
    },
    throwProtectedError: function throwProtectedError(token) {
        if (token === 'YYYY') {
