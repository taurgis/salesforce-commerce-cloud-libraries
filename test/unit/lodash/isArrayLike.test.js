...
var isArrayLike = require('../../../cartridges/lodash/isArrayLike');
var map = require('../../../cartridges/lodash/map');
var _ = require('../../../cartridges/lodash/wrapperLodash');
var asyncFunc = require('../helpers/funcs').asyncFunc;
var genFunc = require('../helpers/funcs').genFunc;
...
describe('isArrayLike', function () {
    it('should return `true` for array-like values', function () {
        ...
        var actual = map(values, isArrayLike);
