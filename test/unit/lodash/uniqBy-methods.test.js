...
describe('uniqBy methods', function () {
    each(['uniqBy', 'sortedUniqBy'], function (methodName) {
        var func = methodName === 'sortedUniqBy' ? sortedUniqBy : uniqBy;
        var isSorted = methodName === 'sortedUniqBy';
        ...
        it('should work with large arrays', function () {
            var largeArray = times(LARGE_ARRAY_SIZE, function () {
                return [1, 2];
            });
