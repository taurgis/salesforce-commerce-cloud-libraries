...
var chain = require('../../../cartridges/lodash/chain');
...
describe('chain', function () {
    ...
    it('should chain multiple methods', function () {
        times(2, function (index) {
            ...
            var expected = { ' ': 9, 'e': 14, 'f': 2, 'g': 1, 'h': 2, 'i': 4, 'l': 2, 'n': 6, 'o': 3, 'r': 2, 's': 2, 't': 5, 'u': 1, 'v': 4, 'w': 2, 'x': 1 };
            var wrapped = index ? _(array).chain() : chain(array);
