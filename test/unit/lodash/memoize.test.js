...
var memoize = require('../../../cartridges/lodash/memoize');
...
describe('memoize', function () {
    ...
    CustomCache.prototype = {
        ...
        'get': function (key) {
            var entry = find(this.__data__, ['key', key]);
    ...
    ImmutableCache.prototype = create(CustomCache.prototype, {
    ...
    it('should use `this` binding of function for `resolver`', function () {
        var fn = function (a) { return a + this.b + this.c; };
        var memoized = memoize(fn, fn);
    ...
    it('should not error if `resolver` is nullish', function () {
        ...
        var actual = map(values, function (resolver, index) {
            try {
    ...
    it('should check cache for own properties', function () {
        ...
        var actual = map(props, function (value) {
    ...
    it('should cache the `__proto__` key', function () {
        ...
        times(2, function (index) {
            var count = 0;
            var resolver = index ? identity : undefined;
