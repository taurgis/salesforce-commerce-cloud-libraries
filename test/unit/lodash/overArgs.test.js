...
var overArgs = require('../../../cartridges/lodash/overArgs');
...
describe('overArgs', function () {
    ...
    it('should provide the correct argument to each transform', function () {
        var argsList = [];
        var transform = function () { argsList.push(slice.call(arguments)); };
        var over = overArgs(noop, transform, transform, transform);
