...
var fill = require('../../../cartridges/lodash/fill');
...
describe('fill', function () {
    ...
    it('should treat falsey `start` values as `0`', function () {
        var expected = map(falsey, constant(['a', 'a', 'a']));
    ...
    it('should treat falsey `end` values, except `undefined`, as `0`', function () {
        ...
        var actual = map(falsey, function (end) {
            var array = [1, 2, 3];
