...
var overSome = require('../../../cartridges/lodash/overSome');
var slice = Array.prototype.slice;
var { stubTrue, stubOne, stubA, stubFalse, stubString, stubNull, stubZero } = require('../helpers/stubs');
...
describe('overSome', function () {
    ...
    it('should return `true` as soon as `predicate` returns truthy', function () {
        ...
        var over = overSome(countFalse, countTrue, countFalse);
